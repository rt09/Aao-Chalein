...
ALLOWED_HOSTS = ['web-production-e4fe.up.railway.app', 'aao-chalein-production.up.railway.app', 'www.aaochalein.online',
                 '127.0.0.1', 'localhost', '0.0.0.0']
CSRF_TRUSTED_ORIGINS = ['https://web-production-e4fe.up.railway.app', 'https://aao-chalein-production.up.railway.app', 'https://www.aaochalein.online'
                        ]
